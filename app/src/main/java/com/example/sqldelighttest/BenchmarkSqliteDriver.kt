...
class BenchmarkSqliteDriver private constructor(
    ...
    @JvmOverloads constructor(
            ...
            callback: SupportSQLiteOpenHelper.Callback = BenchmarkSqliteDriver.Callback(schema),
    ...
    fun executeWithCompileStatement(
            identifier: Int?,
            compiledStatement: SupportSQLiteStatement,
            parameters: Int,
            binders: (SqlPreparedStatement.() -> Unit)?
    ) = execute(identifier, { AndroidPreparedStatement(compiledStatement) }, binders, AndroidStatement::execute)
    ...
    open class Callback(
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            schema.create(BenchmarkSqliteDriver(openHelper = null, database = db, cacheSize = 1))
        }
        ...
        override fun onUpgrade(
            ...
            schema.migrate(BenchmarkSqliteDriver(openHelper = null, database = db, cacheSize = 1), oldVersion, newVersion)
        }
    }
}
